...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private static final String BACKEND_URL = "https://10.0.2.2:8080/";
            ...
            builder.setPositiveButton("Restart demo",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int index) {
                            CardInputWidget cardInputWidget = CheckoutActivity.this.findViewById(R.id.cardInputWidget);
    ...
    private static final class PayCallback implements Callback {
        ...
        public void onFailure(@NonNull Call call, @NonNull final IOException e) {
            ...
            activity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    Toast.makeText(
                            activity, "Errorl: " + e.toString(), Toast.LENGTH_LONG
                    ).show();
                }
            });
        }
